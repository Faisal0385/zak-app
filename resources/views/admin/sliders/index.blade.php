        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Slider Page</h4>
                    <a href="{{ route('slider.create') }}" class="btn btn-dark btn-sm waves-effect waves-light"
                        style="float: right">
                                ...
                                @foreach ($sliders as $key => $slider)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="javascript:void(0)" id="status_btn_{{ $slider->id }}"
                                                class="btn btn-sm btn-{{ $slider->status == 'inactive' ? 'danger' : 'success' }}"
                                                onclick="StatusChange({{ $slider->id }})">
                                                <i class="fa fa-check-circle m-0" style="font-size: 12px"></i>
                                            </a>


                                            <a href="{{ route('slider.edit', $slider) }}" class="btn btn-sm btn-info"
                                                title="Edit Data">
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                ...
                                                onclick="setDeleteAction({{ $slider->id }})">
