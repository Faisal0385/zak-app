                                ...
                                <div class="card-body">
                                    ...
                                    <form id="myForm" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="preview">
                                                <img src="./assets/images/no_image.jpg" class="img img-thumbnail"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="alt" id="alt"
                                                    class="form-control form-control-sm" placeholder="Image Alt" />
                                            </div>
                                        </div>
        ...
        form.addEventListener("submit", async (e) => {
            ...
            if (name.length == 0) {
                ...
                try {
                    ...
                    let res = await axios.post("/admin/category/store", formData, {
                        headers: {
