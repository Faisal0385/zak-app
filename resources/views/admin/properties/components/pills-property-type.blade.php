<div class="tab-pane fade" id="pills-property-type" role="tabpanel" aria-labelledby="pills-property-type-tab">
    <form action="{{ route('properties.update.type', $properties->id) }}" method="POST">
        @csrf
        <div class="row mt-1">
            <div class="col-4">
                <label class="col-form-label">Property Types</label>
                <div class="form-group">
                    <select name="property_type_id" class="form-select form-select-sm js-select-all"
                        aria-label="Default select example">
                        <option value="" selected>Pls Select Property Types</option>
                      ...
                      ">
                        ...
                        <tbody>
                            @foreach ($results as $key => $result)
                                <tr>
                                    <td>{{ $result->propertyType?->name ?? 'No Data' }}</td>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form
                                                            action="{{ route('properties.delete.type', $result->id) }}"
                                                            method="POST">
                                                            @csrf
