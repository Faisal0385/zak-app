                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" style="color: black">
                            <b>Add Property Status</b>
                        </h4>
                        <hr class="m-1" />
                        <form id="myForm" method="POST" action="{{ route('property.status.store') }}">
                            @csrf
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="property_status" id="property_status"
                                            class="form-control form-control-sm" placeholder="Property Status" />
                                    </div>
                                </div>
                            </div>
