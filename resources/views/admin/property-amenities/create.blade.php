                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" style="color: black">
                            <b>Add Property Amenities</b>
                        </h4>
                        <hr class="m-1" />
                        <form id="myForm" method="POST" action="{{ route('property.amenities.store') }}">
                            @csrf
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="name" id="name"
                                            class="form-control form-control-sm" placeholder="Property Amenities" />
                                    </div>
                                </div>
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="icon_class" id="icon_class"
                                            ...
                                            placeholder="Icon Class (fa fa-facebook)" />
                                    </div>
                                </div>
                            </div>
