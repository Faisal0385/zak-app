        ...
        <div class="container" style="background: #031123; padding: 50px; border-radius: 10px;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 mb-4">
                    ...
                    <p>
                        Founded by an Emirati investor with extensive experience in Dubai's real estate market, ZAK
                        Realty a trusted
                        brokerage specializing in off-plan and secondary market properties.
                    </p>
                    <p>
                        With local ecncdt cuide approach, Enjoy tailored investment solutions.
                    </p>
                    <p>
                        Your Vision. Our Expertise. Dubai's Futu
                    </p>
                </div>
