                    ...
                    @foreach ($propertyTypes as $propertyType)
                        <div class="col-6 col-md-6 col-lg-3 mb-1">
                            <div class="row g-0 shadow-sm p-1 rounded">
                                <div class="col-md-4">
                                    <img src="{{ !empty($propertyType->image) ? asset($propertyType->image) : asset('no_image.jpg') }}"
                                        class="img-fluid rounded mr-5" alt="{{ $propertyType->name }}"
                                        style="height: 100%;">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body p-3">
                                        <h6 class="card-title mb-0">{{ $propertyType->name }}</h6>
                                        <p class="card-text"><small class="text-body-secondary">properties</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="card shadow-sm m-1">
                        <div class="position-relative">
                            <img src="{{ asset($project->image) }}" class="card-img-top" alt="Property Image" />
